...
static void c2_chartstep_c2_UR5Model(SFc2_UR5ModelInstanceStruct *chartInstance)
{
  ...
  real_T c2_des[12];
  int32_T c2_i3;
  static real_T c2_dv1[6] = { -185.0, -175.0, 900.0, 0.0, 0.0, 0.0 };

  int32_T c2_i4;
  static real_T c2_dv2[6] = { -185.0, -375.0, 636.0, 0.0, 0.0, 0.0 };
  ...
  real_T c2_a;
  int32_T c2_i7;
  static real_T c2_b[6] = { 0.0, -200.0, -264.0, 0.0, 0.0, 0.0 };
  ...
  c2_vmax = 37.851870252771569;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 14);
  c2_amax = 30.281496202217255;
  _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 16);
  if (CV_EML_IF(0, 1, 0, c2_t <= c2_T_s)) {
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 17);
    c2_A = 30.281496202217255 * c2_mpower(chartInstance, c2_t);
    c2_x = c2_A;
    c2_b_x = c2_x;
    c2_c_x = c2_b_x;
    c2_s = c2_c_x / 2.0;
    _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 18);
    c2_sd = 30.281496202217255 * c2_t;
  } else {
    ...
    if (CV_EML_COND(0, 1, 0, c2_t > c2_T_s)) {
      if (CV_EML_COND(0, 1, 1, c2_t < c2_T - c2_T_s)) {
        ...
        c2_s = 37.851870252771569 * c2_t - 23.65741890798223;
    ...
    if (guard1 == true) {
      ...
      if (CV_EML_COND(0, 1, 2, c2_t >= c2_T - c2_T_s)) {
        if (CV_EML_COND(0, 1, 3, c2_t <= c2_T)) {
          ...
          c2_b_A = -30.281496202217255 * c2_mpower(chartInstance, c2_t - c2_T);
          c2_d_x = c2_b_A;
          c2_e_x = c2_d_x;
          c2_f_x = c2_e_x;
          c2_y = c2_f_x / 2.0;
          c2_s = (c2_y + 378.51870252771567) - 47.314837815964459;
          _SFD_EML_CALL(0U, chartInstance->c2_sfEvent, 24);
          c2_sd = c2_vmax - 30.281496202217255 * ((c2_t - c2_T) + c2_T_s);
        } else {
          guard2 = true;
        }
      } else {
  ...
  for (c2_i8 = 0; c2_i8 < 6; c2_i8++) {
    c2_b_y[c2_i8] /= 331.20386471175124;
  }
  ...
  for (c2_i11 = 0; c2_i11 < 6; c2_i11++) {
    c2_xd_des[c2_i11] = c2_b_y[c2_i11] / 331.20386471175124;
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4081979136U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2865717955U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3759913884U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3757539100U);
}
...
mxArray *sf_c2_UR5Model_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("hHh2vjHnrJt1fUel9d29WC");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,204,213,251,274);
        _SFD_CV_INIT_EML_IF(0,1,1,251,274,324,431);
        _SFD_CV_INIT_EML_IF(0,1,2,324,347,-1,347);

        {
          static int condStart[] = { 258, 267 };

          static int condEnd[] = { 263, 274 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,0,258,274,2,0,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 331, 343 };

          static int condEnd[] = { 339, 347 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,1,331,347,2,2,&(condStart[0]),&(condEnd[0]),
                                3,&(pfixExpr[0]));
        }
...
static void mdlSetWorkWidths_c2_UR5Model(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1263245212U));
  ssSetChecksum1(S,(483473102U));
  ssSetChecksum2(S,(2228635517U));
  ssSetChecksum3(S,(1432934950U));
